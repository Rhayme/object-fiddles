...
//Code Here
for (var keys in user1) {
    if (!user1[keys]) {
        delete user1[keys];
    }
}
//Once you get your truthy Object, Change the remaining
// values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.

//Code Here
user1.name = 'Ray';
user1.username = "MegaBite";
...
makePerson("Jhon", 25, "645-85-33565");
